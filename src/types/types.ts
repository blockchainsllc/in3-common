...
export interface RPCResponse {
    ...
    error?: {
        ...
        message: string
        /**
         * detailed structured information of error
         */
        data?: any
    }
    /**
