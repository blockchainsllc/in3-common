...
export interface RPCResponse {
    ...
    error?: {
        ...
        message: string
        /**
         * detailed structured information of error, can be stack trace
         */
        data?: string
    }
    /**
